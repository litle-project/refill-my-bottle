...
;$.fn.eventCalendar = function(options){
	...
	flags.wrap.find('.eventsCalendar-list').on('click','.eventTitle',function(e){
		...
		var d=$(this).find("b").html();

		$.get( "admin_booking/detail_booking?id="+p+"&date="+d+"", function( data ) {
		  $( "#book_det" ).html( data );
		});
...
$.fn.eventCalendar.defaults = {
	...
	txt_noEvents: "There are no Booking in this period",
	txt_SpecificEvents_prev: "",
	txt_SpecificEvents_after: "Booking:",
	txt_next: "next",
	txt_prev: "prev",
	txt_NextEvents: "Next Booking:",
