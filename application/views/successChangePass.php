...
<head>
	...
	<h1><title> RefillMyBottle - Successful change password</title></h1>
...
<body>
	<div class="container">
		<div class="col-xs-12 text-center"style=" border-collapse:collapse; border-radius: 10px;">
				<center><div style="alignment-baseline: central;">
							<center>
								<img width="200px" src="<?php echo base_url("media/config/sukses.png");?>">
							</center>
						<br><br>
						</div></center>
			</div>
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3 text-center">
				<h2 class="text-success font-bold mgbottom20px" style="color:#428bca;"> Change Password Successful<br /> Please Re-login</h2>	
				</div>
		</div>
	</div>
</body>
