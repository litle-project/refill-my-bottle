			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_editable_1">
					...
					?>
						<tr class="gradeX">
							<td><?php echo $no;?></td>
							<td><?php echo $data[$i]["area_name"];?></td>
							...
							<td>
							<a href="<?php echo site_url($this->uri->segment(1)."/edit/".$data[$i]["area_id"]."");?>" class="btn btn-sm blue"><b>Edit</b></a>
							<a href="<?php echo site_url($this->uri->segment(1)."/delete/".$data[$i]["area_id"]."");?>" class="btn btn-sm red" onclick="return confirm('Are you sure you want to delete <?php echo $data[$i]["area_name"];?> from product table? ')"><b>Delete</b></a>
							</td>
						</tr>
					<?php
							$no++;
