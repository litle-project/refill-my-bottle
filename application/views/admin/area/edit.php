<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("area/edit/".$data[0]['area_id']."") ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">City Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="area_name" value="<?php echo $data[0]['area_name']?>" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">State</label>
					<div class="col-md-6 col-sm-6">
						<select class="form-control" name="city_id">
						<?php foreach ($state as $key) { ?>
							<option value="<?php echo $key['city_id'];?>" <?php if ($key['city_id'] == $data[0]['city_id']) {
								echo "selected";
							}?>><?php echo $key['city_name'];?></option>
						<?php } ?>
						</select>
					</div>
				</div>
