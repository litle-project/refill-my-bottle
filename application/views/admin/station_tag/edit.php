<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("station_tag/edit/".$data[0]['tag_id']."") ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Tag Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="tag_name" value="<?php echo $data[0]['tag_name'];?>" placeholder="Tag of Station" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<textarea name="tag_desc" placeholder="max 500 char!"><?php echo $data[0]['tag_desc'];?></textarea>
					</div>
				</div>
