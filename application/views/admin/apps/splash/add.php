<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("splash/add"); ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Splash Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="splash_name" placeholder="eg: How to Refill Screen" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						...
						<input type="file" class="form-control" name="splash_image"  required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Splash Content</label>
					<div class="col-md-6 col-sm-6">
						<textarea class="form-control" placeholder="Max 500 character!" name="splash_content" required></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">For Page</label>
					<div class="col-md-6 col-sm-6">
						<input type="number" id="page" class="form-control" name="splash_page" min="1" required>
					</div>
				</div>
			</div>
