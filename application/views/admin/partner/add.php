<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("admin_partner/add") ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Partner Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="partner_name" placeholder="Your Partner Name" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Partner Description</label>
					<div class="col-md-6 col-sm-6">
						<textarea class="form-control" name="partner_description" placeholder="Describe this partner" required></textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="partner_url" placeholder="eg: www.partner.com" required>
					</div>
				</div>
			</div>
