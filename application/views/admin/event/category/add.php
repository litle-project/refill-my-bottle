<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("blog_category/add") ?>" method="post">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Category Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="category_name" placeholder="For blog category" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Category Description</label>
					<div class="col-md-6 col-sm-6">
						<textarea class="form-control" name="category_description" placeholder="Describe this category" required></textarea>
					</div>
				</div>
			</div>
