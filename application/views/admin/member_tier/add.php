...
<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("member_tier/add") ?>" method="post" enctype="multipart/form-data">
				<div class="form-body">
					<div class="form-group">
						<label class="col-md-4 col-sm-3 control-label">Tier Name</label>
						<div class="col-md-6 col-sm-6">
							<input type="text" class="form-control" name="tier_name" placeholder="eg: Member Silver" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 col-sm-3 control-label">Tier Bottle</label>
						<div class="col-md-6 col-sm-6">
							<input type="number" class="form-control" name="tier_point" placeholder="eg: 2000 btl" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 col-sm-3 control-label">Tier Reward</label>
						<div class="col-md-6 col-sm-6">
							<textarea class="form-control" name="tier_reward" placeholder="Give this tier reward"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 col-sm-3 control-label">Tier Terms and Condition</label>
						<div class="col-md-6 col-sm-6">
							<textarea class="form-control" name="tier_terms" placeholder="Terms and Condition"></textarea>
						</div>
					</div>
					<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Tier Icon/Image</label>
					<div class="col-md-6 col-sm-6">
						<input type="file" name="tier_image" class="form-control" required>
					</div>
				</div>
				</div>
