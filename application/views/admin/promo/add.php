...
<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("promo/add") ?>" method="post" autocomplete="off" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Promo Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="promo_name" placeholder="Name of This Promo" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="text" name="expired" class="form-control" required/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Minimum Transaction</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" id="price" name="transaction" class="form-control" min="0" required/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Promo Description</label>
					<div class="col-md-6 col-sm-6">
						<textarea name="promo_desc"></textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="file" name="promo_image" class="form-control" required>
					</div>
				</div>
