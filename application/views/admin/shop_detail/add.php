...
<div class="row">
	<div class="col-lg-12 col-md-12">
		...
		<div class="col-lg-5 col-md-5 col-sm-5">
			<ul class="breadcrumb pull-right">
				<li>
					<a href="#" onclick="window.location.href='<?php echo site_url($this->uri->segment(1));?>'">Add Shop List Detail</a>
				</li>
				<li>
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("olshop_detail/add") ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
					...
					<div class="col-md-6 col-sm-6">
						...
						<?php foreach ($data as $key) { ?>
							<option value="<?php echo $key['id_shop'];?>"><?php echo $key['name_product']; ?></option>
						<?php } ?>
						</select>
					</div>
				</div>
