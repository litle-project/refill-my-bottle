...
<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("station_master/add") ?>" method="post" autocomplete="off" enctype="multipart/form-data">
			<div class="form-body">
				
				<!-- <?php 
					if(!empty($uniq[0]['uniq'])){
		        		$uniq_id = sprintf('%07d',$uniq[0]["uniq"]+1);
		        		$uniq_number = "RMB-".$uniq_id."";
			    	}else{

			        	$number = 0;
			        	$uniq_id = sprintf('%07d',$number+1);
		        		$uniq_number = "RMB-".$uniq_id."";
			    } ?> -->
			    <div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Station Uniq Number</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control"  name="uniq_id" >
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Station Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="station_name" placeholder="Name of Station" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<select class="form-control" name="type_id">
							<?php foreach ($type as $cow) {	 ?>
								<option value="<?php echo $cow['type_id'];?>"><?php echo $cow['name_type'];?></option>
							<?php } ?>
						</select>
					</div>
				</div>
					...
					<div class="col-md-6 col-sm-6">
						<select class="form-control" name="type_water_id">
							<?php foreach ($type_water as $low) {	 ?>
								<option value="<?php echo $low['type_water_id'];?>"><?php echo $low['type_water_name'];?></option>
							<?php } ?>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<textarea class="form-control" name="station_address" placeholder="Address of this station" required></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Station Description</label>
					<div class="col-md-6 col-sm-6">
						<textarea name="station_desc"></textarea>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<fieldset class="gllpLatlonPicker">
							...
							<br/>
								<input type="hidden" name="lat" class="gllpLatitude" value="-8.416339099788033"/>
								<input type="hidden" name="long" class="gllpLongitude" value="115.17376840625002"/>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="station_phone" placeholder="+62">
					</div>
				</div>
				<div class="form-group">
					<div class="material-switch">
	                    <input id="point" name="general_point" checked type="checkbox" value="1"/>
	                    <label for="point" class="label-primary"></label>
						<p style="margin-left: 50px; margin-top:-17px;">Give More Point If User Refill Here</p>
	                </div>
                </div>
				<div class="form-group" id="point_field" style="display:">
					<label class="col-md-4 col-sm-3 control-label">Station Point</label>
					<div class="col-md-5 col-sm-5">
						<input type="number" class="form-control" name="station_point" min="1">
					</div>
				...
				<div class="form-group" style="display:">
					...
					<div class="col-md-5 col-sm-5">
						<input type="text" id="cost" class="form-control" name="cost" min="0">
					</div>
					<label class="control-label"><b>Cost</b> / Refill</label>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Open & Close Hours</label>
					<div class="col-md-3 col-sm-4">
						<div class="input-group clockpicker" data-align="top" data-autoclose="true">
						    <input type="text" name="open" class="form-control" value="07:00" style="width: 250px !important;" required>
						</div>
					</div>
					<div class="col-md-3 col-sm-3"">
						<div class="input-group clockpicker" data-align="top" data-autoclose="true">
						    <input type="text" name="close" class="form-control" value="20:00" style="width: 250px !important;" required>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="checkbox" id="check_1" 	onClick="ckChange(this)"	name="opening_days[]"  value="Daily">Daily<br/>
						<input type="checkbox" id="check_2"		onClick="ckChange(this)"	name="opening_days[]"  value="Monday">Monday<br/>
						<input type="checkbox" id="check_3"		onClick="ckChange(this)"	name="opening_days[]"  value="Tuesday">Tuesday<br/>
						<input type="checkbox" id="check_4"		onClick="ckChange(this)" 	name="opening_days[]"  value="Wednesday">Wednesday<br/>
						<input type="checkbox" id="check_5"		onClick="ckChange(this)"	name="opening_days[]"  value="Thursday">Thursday<br/>
						<input type="checkbox" id="check_6"		onClick="ckChange(this)"	name="opening_days[]"  value="Friday">Friday<br/>
						<input type="checkbox" id="check_7"		onClick="ckChange(this)"	name="opening_days[]"  value="Saturday">Saturday<br/>
						<input type="checkbox" id="check_8"		onClick="ckChange(this)"	name="opening_days[]"  value="Sunday">Sunday<br/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="fb_id" placeholder="Your Facebook Page Link">
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="text" name="website" class="form-control" placeholder="Fill If Available">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
            			<input id="tag" type="text" class="tags" name="station_tag" />
