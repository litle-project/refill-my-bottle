<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<br/>
			<form class="form-horizontal" action="<?php echo site_url("station_category/edit/".$data[0]['category_id'].""); ?>" method="post" enctype="multipart/form-data">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6">
							<textarea class="form-control" name="category_desc" required><?php echo $data[0]['category_desc']?></textarea>
						</div>
					</div>
				</div>
