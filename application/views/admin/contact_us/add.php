<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("contactus/add"); ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">contact title</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="contact_title" placeholder="Ex : CEO contact" required>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						...
						<input type="file" class="form-control" name="image_contact" >
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="contact_target" placeholder="Ex : CEO contact" required>
					</div>
				</div>
