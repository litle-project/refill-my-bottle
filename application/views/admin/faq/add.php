<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("admin_faq/add") ?>" method="post">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Frequently Ask</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="ask" placeholder="eg: How to purchase after buy" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Answer</label>
					<div class="col-md-6 col-sm-6">
						<textarea class="form-control" name="answer" placeholder="Give best answer for the FAQ" required></textarea>
					</div>
				</div>
			</div>
