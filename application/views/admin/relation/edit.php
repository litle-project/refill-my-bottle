<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("relation/edit/".$data[0]['relation_id']."") ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Relation Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="relation_name" value="<?php echo $data[0]['relation_name'];?>" placeholder="Name of Station" required>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Relation Description</label>
					<div class="col-md-6 col-sm-6">
						<textarea name="relation_description" placeholder="max 500 char!"><?php echo $data[0]['relation_description'];?></textarea>
					</div>
				</div>
	...
	<!-- timepicker end -->
	<script>
		CKEDITOR.replace( 'relation_description' );
	</script>