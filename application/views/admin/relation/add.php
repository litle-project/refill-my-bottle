<div class="row">
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet box grey">
			...
			<form class="form-horizontal" action="<?php echo site_url("relation/add") ?>" method="post" enctype="multipart/form-data">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-4 col-sm-3 control-label">Relation Name</label>
					<div class="col-md-6 col-sm-6">
						<input type="text" class="form-control" name="relation_name" placeholder="Name of Station" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6">
						<textarea name="relation_description" placeholder="max 500 char!"></textarea>
					</div>
				</div>
